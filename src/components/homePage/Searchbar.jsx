...
const Searchbar = () => {
    ...
    return (
        <div className="font-notoTC flex flex-row items-center w-full  mt-5 px-5 box-border">
            ...
            <input
                type="text"
                className="w-full mx-2 border-2 rounded-xl  border-zinc-500 outline-none text-lg py-1"
                placeholder=" 想吃什麼..."
                id="inputKeyword"
